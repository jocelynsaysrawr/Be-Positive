...
BloodTransfusionRules = {
  ...
  receive_patient: function(blood_inventory, patient) {
    switch (patient.blood_type) {
      case "AB_POS":
        console.log("AB_POS inventory: ", blood_inventory);
        if (blood_inventory.AB_POS >= 1) {
          return BloodType.AB_POS;
        } else if (blood_inventory.AB_NEG >= 1) {
          return BloodType.AB_NEG;
        } else if (blood_inventory.A_POS >= 1) {
          return BloodType.A_POS;
        } else if (blood_inventory.A_NEG >= 1) {
          return BloodType.A_NEG;
        } else if (blood_inventory.B_POS >= 1) {
          return BloodType.B_POS;
        } else if (blood_inventory.B_NEG >= 1) {
          return BloodType.B_NEG;
        } else if (blood_inventory.O_POS >= 1) {
          return BloodType.O_POS;
        } else if (blood_inventory.O_NEG >= 1) {
        ...
        break;
      case "AB_NEG":
        console.log("AB_NEG inventory: ", blood_inventory);
        ...
        break;
      case "A_POS":
        console.log("A_POS inventory: ", blood_inventory);
        ...
        break;
      case "A_NEG":
        console.log("A_NEG inventory: ", blood_inventory);
        ...
        break;
      case "B_POS":
        console.log("B_POS inventory: ", blood_inventory);
        ...
        break;
      case "B_NEG":
        console.log("B_NEG inventory: ", blood_inventory);
        ...
        break;
      case "O_POS":
        console.log("O_POS inventory: ", blood_inventory);
        ...
        break;
      case "O_NEG":
        console.log("O_NEG inventory: ", blood_inventory);
